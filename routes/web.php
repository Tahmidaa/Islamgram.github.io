...
Route::post('post/delete/{id}', 'App\Http\Controllers\PostsController@destroy')->name('post.delete'); 
...
Route::post('user/delete/{id}', 'App\Http\Controllers\ProfilesController@destroy')->name('user.delete');
